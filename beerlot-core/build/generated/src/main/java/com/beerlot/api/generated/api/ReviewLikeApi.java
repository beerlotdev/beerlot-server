...
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen")
    @Tag(name = "ReviewLike", description = "beer review like management")
    public interface ReviewLikeApi {
            ...
            /**
            * POST /reviews/{reviewId}/likes : Like the review with specified id
            *
            ...
            */
            ...
            value = "/reviews/{reviewId}/likes"
            )
        default ResponseEntity<Void> createReviewLike(
        @Parameter(name = "reviewId", description = "beer review id", required = true) @PathVariable("reviewId") Long reviewId
            ...
            /**
            * DELETE /reviews/{reviewId}/likes : UnLike the review with specified id
            *
                * @param reviewId beer review id (required)
        ...
        default ResponseEntity<Void> deleteReviewLike(
        @Parameter(name = "reviewId", description = "beer review id", required = true) @PathVariable("reviewId") Long reviewId
